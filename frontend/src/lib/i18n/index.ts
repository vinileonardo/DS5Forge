...
const english = {
  ...
  "games.description":
    "Keep profiles tied to live game processes; foreground only decides priority when more than one registered game is running.",
  ...
  "games.candidatesHelp": "Live and recent executables are suggestions only; saving remains explicit.",
  "games.candidateRunning": "running",
  "games.candidateRecent": "recent",
  ...
  "games.adaptiveTriggerStrength": "Reactive trigger strength",
  "games.adaptiveTriggerStrengthHelp":
    "Controls the overall strength of DS5Forge-generated reactive resistance and pulses for this game. 45% is the softer default; higher values make kicks and progressive resistance more pronounced.",
  ...
  "games.outputReports": "Virtual output reports",
  "games.outputPassthrough": "Physical feedback passthrough",
  "games.suppressionVerified": "Suppression verified",
  "games.doubleInputRisk": "Double-input risk",
  "games.yes": "Yes",
  "games.no": "No",
  "games.inputIsolationTitle": "Double-input protection",
  "games.inputIsolationHelp":
    "When Remap is active, HidHide can hide the physical DualSense from games while keeping DS5Forge allowlisted.",
  "games.inputIsolationToggle": "Isolate physical DualSense",
  "games.inputIsolationActive":
    "Protection active. The physical controller is hidden from ordinary applications.",
  "games.inputIsolationReady": "HidHide is ready for the connected wired DualSense.",
  "games.inputIsolationUnavailable":
    "Protection is unavailable until HidHide and the wired DualSense are detected.",
  "games.inputIsolationRemapOnly": "Switch Input mode to Remap to enable double-input protection.",
  "games.hidhideCloak": "HidHide cloak",
  "games.ds5forgeAllowed": "DS5Forge allowlisted",
  "games.deviceHidden": "DualSense hidden",
  ...
  "games.activeGameHelp":
    "The game remains active while its configured process is alive, even when it is in the background.",
  "games.profile": "Profile",
  "games.origin": "Origin",
  "games.originAutomatic": "Automatic",
  "games.originManual": "Manual",
  "games.rule": "Rule",
  "games.manualOverride": "Manual override",
  "games.overrideActive": "active",
  "games.overrideNone": "none",
  "games.noActiveGame": "No active game",
  "games.noActiveGameHelp": "No enabled rule currently has a live matching process.",
  "games.automation": "Game automation",
  "games.automationOn": "Rules track live processes; foreground only changes priority",
  ...
  "games.exitPolicyHelp": "What happens when the active game's configured process actually exits.",
  ...
  "games.manualOverrideHelp":
    "Manual profile or mode changes remain until a real game-process transition supersedes them.",
  ...
  "games.actionActivate": "Activate",
  "games.actionNone": "No action",
  ...
  "games.ruleEnabledHelp": "Track these executable identities while their processes are running.",
  ...
  "games.conflictWarning": "warning",
  "games.conflictInfo": "info",
  ...
  "controller.calibrationScope": "Where drift correction applies",
  "controller.calibrationHint":
    "Drift correction affects DS5Forge Exclusive virtual mirroring. Games reading the physical DualSense directly still receive raw stick input.",
  "controller.calibrationSaved": "Stick calibration applied to the current runtime state.",
  "controller.driftNotEnoughSamples":
    "Not enough stick samples were captured. Keep the controller connected and try again.",
  "controller.driftApplied": "Recommended drift correction applied.",
  "controller.driftTestTitle": "Automatic drift test",
  "controller.driftTestHelp":
    "Samples both sticks for 3 seconds, separates center offset from jitter and recommends the smallest practical deadzone.",
  "controller.driftMeasuring": "Measuring…",
  "controller.driftReady": "Ready to test",
  "controller.driftHandsOff": "Leave both sticks completely untouched",
  "controller.driftSamples": "samples",
  "controller.driftInstruction":
    "Place the controller on a stable surface and do not touch either stick during the test.",
  "controller.driftStart": "Test drift for 3s",
  "controller.leftStick": "Left stick",
  "controller.rightStick": "Right stick",
  "controller.driftCenter": "Center drift",
  "controller.driftJitter": "Residual jitter",
  "controller.driftRecommended": "Recommended deadzone",
  "controller.driftCenterCorrection": "the recommendation also corrects each stick center",
  "controller.saving": "Applying…",
  "controller.driftApply": "Apply recommended correction",
  "controller.liveStickPlanes": "Live stick planes",
  "controller.liveStickPlanesHelp":
    "The outlined circle shows the configured deadzone; the dot is the latest validated raw sample.",
  "controller.manualCalibration": "Manual calibration",
  "controller.manualCalibrationHelp":
    "Fine-tune the recommendation or enter center offsets manually. Full profiles preserve these values.",
  "controller.leftDeadzone": "Left deadzone",
  "controller.rightDeadzone": "Right deadzone",
  "controller.deadzoneHelp": "Normalized radial deadzone. Lower values preserve more fine movement.",
  "controller.leftCenterX": "Left center X",
  "controller.leftCenterY": "Left center Y",
  "controller.rightCenterX": "Right center X",
  "controller.rightCenterY": "Right center Y",
  "controller.calibrationUnsaved": "Unsaved calibration changes",
  "controller.calibrationUpToDate": "Calibration is up to date.",
  "controller.saveCalibration": "Apply calibration",
...
const portuguese: Dictionary = {
  ...
  "games.description":
    "Mantenha os perfis vinculados aos processos dos jogos em execução; o primeiro plano só define prioridade quando há mais de um jogo registrado aberto.",
  ...
  "games.candidateRunning": "em execução",
  "games.candidateRecent": "recente",
  ...
  "games.adaptiveTriggerStrength": "Força dos gatilhos reativos",
  "games.adaptiveTriggerStrengthHelp":
    "Controla a força geral da resistência e dos pulsos reativos gerados pelo DS5Forge neste jogo. 45% é o padrão mais suave; valores maiores deixam os trancos e a resistência progressiva mais perceptíveis.",
  ...
  "games.outputReports": "Relatórios de saída virtual",
  "games.outputPassthrough": "Retorno físico de vibração e efeitos",
  "games.suppressionVerified": "Supressão verificada",
  "games.doubleInputRisk": "Risco de entrada duplicada",
  "games.yes": "Sim",
  "games.no": "Não",
  "games.inputIsolationTitle": "Proteção contra entrada duplicada",
  "games.inputIsolationHelp":
    "Com o remapeamento ativo, o HidHide oculta o DualSense físico dos jogos e mantém o DS5Forge autorizado a ler o controle.",
  "games.inputIsolationToggle": "Isolar o DualSense físico",
  "games.inputIsolationActive": "Proteção ativa. O controle físico está oculto dos demais aplicativos.",
  "games.inputIsolationReady": "O HidHide está pronto para o DualSense conectado por USB.",
  "games.inputIsolationUnavailable":
    "A proteção fica indisponível até detectar o HidHide e o DualSense conectado por USB.",
  "games.inputIsolationRemapOnly":
    "Troque o modo de entrada para Remapear teclado/mouse para ativar a proteção.",
  "games.hidhideCloak": "Ocultação do HidHide",
  "games.ds5forgeAllowed": "DS5Forge autorizado",
  "games.deviceHidden": "DualSense oculto",
  ...
  "games.activeGameHelp":
    "O jogo continua ativo enquanto o processo configurado estiver aberto, mesmo em segundo plano.",
  "games.profile": "Perfil",
  "games.origin": "Origem",
  "games.originAutomatic": "Automática",
  "games.originManual": "Manual",
  "games.rule": "Regra",
  ...
  "games.noActiveGameHelp": "Nenhuma regra ativada possui um processo correspondente em execução.",
  "games.automation": "Automação de jogos",
  "games.automationOn": "As regras acompanham processos em execução; o primeiro plano só altera a prioridade",
  ...
  "games.exitPolicyHelp":
    "Define o que acontece quando o processo configurado do jogo ativo realmente é encerrado.",
  ...
  "games.manualOverrideHelp":
    "Alterações manuais de perfil ou modo permanecem até uma transição real de processo de jogo substituí-las.",
  ...
  "games.actionActivate": "Ativar",
  "games.actionNone": "Nenhuma ação",
  ...
  "games.ruleEnabledHelp":
    "Acompanha essas identidades de executável enquanto os processos estiverem em execução.",
  ...
  "games.mouseCodeHelp": "Use esquerdo, direito, meio, mouse4 ou mouse5.",
  ...
  "games.conflictWarning": "atenção",
  "games.conflictInfo": "informação",
  "games.runtimeLoading": "Carregando estado do sistema",
  ...
  "controller.calibrationScope": "Onde a correção de drift atua",
  "controller.calibrationHint":
    "A correção de drift afeta o espelhamento virtual do modo Exclusivo do DS5Forge. Jogos que leem o DualSense físico diretamente continuam recebendo o analógico bruto.",
  "controller.calibrationSaved": "Calibração dos analógicos aplicada ao estado atual.",
  "controller.driftNotEnoughSamples":
    "Não foi possível capturar amostras suficientes. Mantenha o controle conectado e tente novamente.",
  "controller.driftApplied": "Correção de drift recomendada aplicada.",
  "controller.driftTestTitle": "Teste automático de drift",
  "controller.driftTestHelp":
    "Mede os dois analógicos por 3 segundos, separa desvio do centro de jitter e recomenda a menor zona morta prática.",
  "controller.driftMeasuring": "Medindo…",
  "controller.driftReady": "Pronto para testar",
  "controller.driftHandsOff": "Não toque em nenhum dos analógicos",
  "controller.driftSamples": "amostras",
  "controller.driftInstruction":
    "Deixe o controle apoiado em uma superfície estável e não toque nos analógicos durante o teste.",
  "controller.driftStart": "Testar drift por 3s",
  "controller.leftStick": "Analógico esquerdo",
  "controller.rightStick": "Analógico direito",
  "controller.driftCenter": "Desvio do centro",
  "controller.driftJitter": "Jitter residual",
  "controller.driftRecommended": "Zona morta recomendada",
  "controller.driftCenterCorrection": "a recomendação também corrige o centro de cada analógico",
  "controller.saving": "Aplicando…",
  "controller.driftApply": "Aplicar correção recomendada",
  "controller.liveStickPlanes": "Analógicos em tempo real",
  "controller.liveStickPlanesHelp":
    "O círculo tracejado mostra a zona morta configurada; o ponto mostra a amostra bruta validada mais recente.",
  "controller.manualCalibration": "Ajuste manual",
  "controller.manualCalibrationHelp":
    "Refine a recomendação ou informe os centros manualmente. Perfis completos preservam esses valores.",
  "controller.leftDeadzone": "Zona morta esquerda",
  "controller.rightDeadzone": "Zona morta direita",
  "controller.deadzoneHelp":
    "Zona morta radial normalizada. Valores menores preservam movimentos mais finos.",
  "controller.leftCenterX": "Centro esquerdo X",
  "controller.leftCenterY": "Centro esquerdo Y",
  "controller.rightCenterX": "Centro direito X",
  "controller.rightCenterY": "Centro direito Y",
  "controller.calibrationUnsaved": "Alterações de calibração não aplicadas",
  "controller.calibrationUpToDate": "Calibração atualizada.",
  "controller.saveCalibration": "Aplicar calibração",
